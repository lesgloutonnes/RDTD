...
import { createTitleAnimState, updateTitleScreenAnim, drawTitleScreenFrame } from "./render/title-screen.js";
import {
  withAssetCacheBust,
  applyCssTextureCacheBust,
} from "./config/asset-cache.js";
...
const SPIRE_LAYOUTS = [
  ...
  },
  {
    ...
    pads: [
      ...
      { x: 740, y: 200 }, { x: 740, y: 370 }, { x: 880, y: 200 },
      { x: 380, y: 270 },
    ],
  },
  {
  ...
  },
  {
    ...
    pads: [
      ...
      { x: 720, y: 150 }, { x: 200, y: 265 }, { x: 860, y: 200 },
    ],
  },
  {
    name: "Le Pentacle",
    ...
    pads: [
      ...
      { x: 750, y: 506 },
      { x: 320, y: 326 }, { x: 780, y: 180 }, { x: 704, y: 368 },
